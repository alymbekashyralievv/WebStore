...
// import { useNavigate } from "react-router-dom"; // Добавьте useNavigate

// const Header = () => {
//   const [isOpen, setIsOpen] = useState(false);
//   const navigate = useNavigate(); // Для перехода на страницу избранных
...
//           <h2 className="text-[34px] font-bold cursor-pointer">Behoof</h2>
...
//           />
//           <button
//             className="w-[52px] h-[52px] bg-[#f4efef] rounded-[10px] flex items-center justify-center cursor-pointer relative"
//             onClick={() => navigate("/favorite")} // Переход на страницу избранных
//           >
//             <GoHeart />
//             {favorites.length > 0 && (
//               <span className="absolute top-0 right-0 bg-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs"></span>
//             )}
//           </button>
